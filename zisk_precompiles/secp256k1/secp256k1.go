...
// Arguments are described here in secp256k1 files: https://github.com/0xPolygonHermez/zisk/tree/0207f975d0f03724f6f5784692ee2725e0d340d3/ziskos/entrypoint/src/syscalls
...
//go:noinline
func Secp256k1Dbl(arr *Point256) {
	ptr := uintptr(unsafe.Pointer(arr))
	syscall_secp256k1_dbl(ptr)
}

func syscall_secp256k1_add(ptr uintptr)
func syscall_secp256k1_dbl(ptr uintptr)
